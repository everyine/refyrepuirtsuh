...
if __name__ == "__main__":
    create_table()
    # insert_player(1, "Эмиль")
    # insert_player(2, "Глеб")
    # insert_player(3, "Матвей")
    # insert_player(4, "Леха")
    # insert_player(5, "Матвей2")
    # insert_player(6, "Артём")
    ...
    # print(vote("citizen_vote", "Камилла", 4))
    print(mafia_kill())
    print(citizen_kill())
